...
int main(void){
    ...
    int s=0,r=0;
    long position,cylindernum,numsectors,numbers=0,index=0,i,headcylinder=0,d,iterate=0,l,count=0,sumsectors=0;
    printf("Start\n");
        ...
        if(tcurrent==tarrival){
            ...
            numbers--;
               ...
               if(numbers>0){
                   ...
                   sumseek+=seekmin;
                   completion = (double)(seekmin + temp1->latency + (temp1->numsectors * transfer));
                    tcompletion = tcurrent + completion;
                   
                   delay = labs(tcurrent - temp1->arrival);

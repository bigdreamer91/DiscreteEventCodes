...
int main(void){
    ...
    int l = 0,c=0;
    double x,y,minfailure,minservice=5000.0,t,servicetime,failuretime,operationtime,diff,sumoperation = 0.0;
        ...
        if(t==minfailure){
           ...
           y = Erlang(6, 2.5);
            ...
            servicetime = minfailure + y;
                ...
                if(root==NULL){
                 ...
                 q = root;
                 while(q!=NULL){
                     if((q->workinghour<3840.0)&&(q->nextinline==0)){
                         diff = fabs(q->servicetime - minfailure);
                     }
                     else{
                         diff = 21.0;
                     }
            ...
            if(temp3==NULL){
                ...
                if(c==1){
                    temp3->nextinline = temp1->machinenum;
                    temp3->nextservicetime = temp3->servicetime + y;
           ...
           SelectStream(1);
            ...
            failuretime = minservice + x;
                    ...
                    temp5->operationtime += fabs(temp5->failuretime - minservice);
                
                }
            
            if(temp4->nextinline>0){
                temp4->workinghour += fabs(temp4->nextservicetime - temp4->servicetime);
                temp4->servicetime = temp4->nextservicetime;
                temp4->machinenum = temp4->nextinline;
                temp4->nextinline = 0;
                temp4->nextservicetime = 0.0;
